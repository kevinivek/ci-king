...
public class IssueController : MonoBehaviour {
	...
	void Start () {
		...
		issues[0].addOption("Give him some grain", new int[] {0, -10, 10, 0, 0, -10}); //subtract from food stores
		...
		issues [1].addOption ("Send help right away", new int[] {-10, -10, 10, 0, 0, 0});  //subtract money from the coffers
		issues[1].addOption("Find the child, but force her into labor at the castle", new int[] {0, 10, -10, 10, 10, 0});
		issues[1].addOption("Have him beheaded for suggesting you stoop to helping him", new int[] {10, 5, 0, 5, 0, 0}); //stats will need to affect all other villagers
		...
		issues [2].addOption ("Lower the taxes", new int[] {0, -10, 10, 0, -10, 0});
		issues [2].addOption ("Raise the taxes", new int[] {0, 10, 0, 5, 10, 0});
		issues[2].addOption("Have him beheaded for his insolence", new int[] {10, 5, 0, 5, 0, 0}); //stats will need to affect all other villagers
	}
